    ...
    for (let rowNumber = 2; rowNumber <= worksheet.rowCount; rowNumber++) {
      ...
      try {
        const customerData = {
          ...
          companyTerm: typeof row.getCell(10).value === 'number' ? row.getCell(10).value as number : null,
          incorporationDate: row.getCell(11).value?.toString() || null,
          shareholderOne: row.getCell(12).value?.toString() || null,
          certificateNumber: typeof row.getCell(13).value === 'number' ? row.getCell(13).value as number : null,
          identification: row.getCell(14).value?.toString() || null,
          ownership: row.getCell(15).value?.toString() || null,
          numberOfSharesHeld: typeof row.getCell(16).value === 'number' ? row.getCell(16).value as number : null,
          date: typeof row.getCell(17).value === 'number' ? row.getCell(17).value as number : null,
          month: row.getCell(18).value?.toString() || null,
          year: typeof row.getCell(19).value === 'number' ? row.getCell(19).value as number : null,
          print: row.getCell(20).value?.toString() || null,
          excelId: typeof row.getCell(21).value === 'number' ? row.getCell(21).value as number : null,
          ...
          certificateNumber2: typeof row.getCell(28).value === 'number' ? row.getCell(28).value as number : null,
          ...
          numberOfSharesHeld2: typeof row.getCell(38).value === 'number' ? row.getCell(38).value as number : null,
          field1: typeof row.getCell(39).value === 'number' ? row.getCell(39).value as number : null,
          legalIdInWords: row.getCell(40).value?.toString() || null,
          renewalStartDate: row.getCell(41).value?.toString() || null,
          active: typeof row.getCell(42).value === 'number' ? row.getCell(42).value as number : null,
          archived: typeof row.getCell(43).value === 'number' ? row.getCell(43).value as number : null,
          ...
          activeTaxation: typeof row.getCell(47).value === 'number' ? row.getCell(47).value as number : null,
          ...
          dissolvedRecord: typeof row.getCell(57).value === 'number' ? row.getCell(57).value as number : null,
